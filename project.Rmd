...
- Identificar un subconjunto de antígenos inmunogénicos de _P. vivax_
...
- Identificar antígenos con antigenicidad diferenciada según la
exposición y severidad de los pacientes con malaria vivax.

*Secundarios*

- Identificar los antígenos con mayor antigenicidad en los pacientes 
con malaria vivax.

- Caracterizar los antígenos identificados según parámetros disponibles en la base de datos PlasmoDB.
...
un subconjunto de antígenos inmunogénicos 
con relevancia clínica en _P. vivax_.

<!--
Los pacientes con malaria vivax no-severa reconocen 
un subconjunto de antígenos inmunogénicos 
con relevancia clínica contra la malaria vivax severa.
-->
...
antígenos con antigenicidad diferenciada con respecto a 
los pacientes sin eventos previos reportados.
...
“reactivo” a los antígenos que posean un valor dos veces mayor
que la media.
...
## Operacionalización de las variables
  ...
  **Variable**                       **Dimensión**                      **Indicador**                       **Clasificación**      **Escala de medición**
  ---------------------------------- ---------------------------------- ---------------------------------- ---------------------- ------------------------
  Antigenicidad                      Reactividad antígeno-anticuerpo    Intensidad de fluorescencia:         Cuantitativa           Razón
...
**Malaria.-** (también llamada paludismo) es una infección 
causada por un parásito del género *Plasmodium* que se transmite 
de un humano a otro por la picadura de mosquitos anofeles infectados.

**Malaria severa.-** Clasificación de los
pacientes con malaria según parámetros clínicos y de laboratorio.

**Antígeno.-** Molécula que se une con productos de la respuesta inmune, 
como anticuerpos o receptores de células T o B. [@abbas2012]

**Antigenicidad.-** Capacidad que posee una molécula de combinarse
específicamente con productos de la respuesta inmune, como
anticuerpos y receptores de células T o B.

**Inmunógeno.-** Un antígeno que induce una respuesta inmunitaria. [@abbas2012]

**Inmunogenicidad.-** Capacidad que posee un antígeno de inducir 
por si solo una respuesta inmunitaria.

<!-- 

Para el presente estudio, a mayor antigenicidad, más
...
**Microarreglo de proteínas.-** Matriz o arreglo de polipéptidos, representantes de exones o segmentos proteícos entre 100 a 1000 aminoácidos, impresos
...
**Anticuerpo.-** Tipo de molécula glucoprotéica, también llamada inmunoglobulina (Ig), producido por los linfocitos B, que se une a los antígenos, con un grado alto de especificidad y afinidad. [@abbas2012]

**Anticuerpo secundario.-** Anticuerpo específico a todos los
anticuerpos del hospedero, y en este caso, conjugado con biotina.

**Fluoróforo.-** componente de una molécula que brinda la cualidad 
de fluorescencia. En este caso, el fluoróforo Cy5 está conjugado 
con estreptavidina para adherirse en forma específica a los 
anticuerpos secundarios.

**Fluorescencia.-** luminiscencia causada por la absorción y posterior emisión de radiación por parte un fluoróforo. A diferencia de la fosforescencia, esta tiene un tiempo característico muy corto: de 10^-5^ a 10^-8^ segundos.
...
\begin{tabular}{ll c m{2cm}m{2cm}m{2cm}m{1.5cm}m{2cm} @{}m{0pt}@{} }
  ...
  \begin{minipage}{4cm}
  \underline{General}\\
  Identificar un subconjunto de antígenos inmunogénicos
  de \textit{P. vivax} con relevancia clínica.
  \end{minipage} & 
  ...
  Razón &
  Plasma sanguíneo &\\[12ex]
  \cline{2-8}
  
   & 
  \begin{minipage}{4cm}
  \underline{Principal}\\
  Identificar antígenos de \textit{P. vivax} con antigenicidad diferenciada
