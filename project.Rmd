...
## Operacionalización de las variables
  ...
  **Variable**                                   **Dimensión**                                  **Indicador**                                   **Tipo de variable**   **Escala de medición**
  ---------------------------------------------- ---------------------------------------------- ---------------------------------------------- ---------------------- ------------------------
  Reactividad antígeno-anticuerpo                Intensidad de fluorescencia                    0 - 6000 pixeles                               Cuantitativa           Razón
  
  Chip del microarreglo de proteínas             Posición de proteínas dentro del microarreglo  *P. vivax* / *P. falciparum*                   Cualitativa            Nominal
...
\afterpage{
    ...
    \begin{landscape}
        \centering
          ...
          % etc. ...
          \end{tabular}
        \captionof{table}{Landscape rotated Table caption}
        \label{tab:land}
    \end{landscape}
    \clearpage
}