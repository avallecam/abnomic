...
\item
  ...
  \item
    ...
    Estudios longitudinales han sugerido que la intensidad de la
    respuesta de anticuerpos en poblaciones con poca inmunidad, en un
    inicio pueden actuar como marcadores de exposición. Luego de una
    exposición constante, esta respuesta incrementa hasta superar un
    umbral de protección, donde los anticuerpos pueden actuar como
    marcadores de
  ...
  \item
    ...
    ha demostrado que esta adquisición natural por la exposición
    acumulada a malaria otorgue una protección esterilizante o de
    resistencia a la
    ...
    \item
      ...
      IL-1\(\beta\) e
      IL-6\textsuperscript{\protect\hyperlink{ref-baird2013}{39}} junto
      ...
      \emph{var} de \emph{P. falciparum} e involucrados en la secreción
      de proteínas adhesivas a RBC y
    ...
    \item
      ...
      En 1961, la transferencia pasiva de anticuerpos donados por
      adultos con inmunidad adquirida de forma natural tuvo una alta
      efectividad en la disminución de la parasitemia periférica y
      resolución de síntomas clínicos en niños con
      ...
      proteínas de superficie como MSP1, MSP1-P (región C-terminal),
      MSP3 (PvMSP-3\(\alpha\), PvMSP-3\(\beta\)) y
    ...
    \item
      ...
      fase II en Colombia con \emph{P. vivax} encontró que luego de
      siete inmunizaciones a lo largo de 56 semanas y una reexposición
      con esporozoitos infecciosos, 5/12 voluntarios obtuvieron dicha
      protección y las respuestas de anticuerpos Ig1 anti-PvCSP
...
\item
  ...
  por subunidades (e.g. \sout{HBsAg contra hepatitis B}) como por
  organismos completos atenuados (e.g. \sout{BCG contra tuberculosis})
  han fracazado. Ensayos clínicos han demostrado que los actuales
  candidatos poseen un pobre inmunogenicidad y protección contra la
  malaria (e.g.~RST,S).
...
\item
  ...
  \item
    ...
    transmembrana en base a filtros por punto isoeléctrico, exclusión de
...
\item
  ...
  microarreglos de
  ADN.\textsuperscript{\protect\hyperlink{ref-sundaresh2006}{52}} Ambas
  ...
  microarreglos,\textsuperscript{\protect\hyperlink{ref-allison2006}{53}}
  ...
  \item
    ...
    \item
      ...
      basados en
      microarreglos,\textsuperscript{\protect\hyperlink{ref-brazma2001}{54}}
      se requiere definir 6 secciones:
      ...
      Cada una de estas secciones será descrita en detalle en la sección
      de \protect\hyperlink{meto}{metodología}.
    \item
      ...
      instrumento.\textsuperscript{\protect\hyperlink{ref-kreil2005bullet}{55}}
      Este fenómeno se evidencia en el incremento de la varianza de las
      medidas directamente proporcional al incremento de su intensidad.
      ...
      experimental, este procedimiento es ejecutado de tres formas:
      ...
      \item
        ...
        proteínas;\textsuperscript{\protect\hyperlink{ref-King2015FOC}{51},\protect\hyperlink{ref-arevalo2016}{56}}
        y
      \item
        ...
        muestras.\textsuperscript{\protect\hyperlink{ref-huber2002vsn}{57}}
      \item
        modelo robusto lineal o RLM, empleando una regresión robusta a
        un modelo lineal y diseñado para microarreglos de
        proteínas.\textsuperscript{\protect\hyperlink{ref-sboner2009rlm}{58}}
      \end{itemize}

      Tercero, el filtrado en experimentos a larga escala permite
      incrementar el poder de detección de elementos con expresión
      diferenciada.\textsuperscript{\protect\hyperlink{ref-bourgon2010filter}{59}}
      Dado que el proceso de inferencia estadística en microarreglos es
      ejecutada por comparación múltiple de varios elementos (genes o
      proteínas), este procedimiento retira de forma preliminar e
      independiente a los elementos con reducidas probabilidades de
    ...
    \item
      ...
      hipótesis.\textsuperscript{\protect\hyperlink{ref-smyth2004ebayes}{60}}
      ...
      \item
        ...
        del bajo número de réplicas (de antígenos o
        muestras);\textsuperscript{\protect\hyperlink{ref-baldi2001cybert}{61}}
        y
      \item
        amplio número de hipótesis puestas a prueba en forma simultánea
        en los que test estadísticos tradicionales pueden llevar a una
        largo número de falsos
        positivos.\textsuperscript{\protect\hyperlink{ref-kayala2012cyber}{62}}
      \end{itemize}

      Ante el primer problema, un enfoque bayesiano empírico permite
      reducir (o moderar) las varianzas de todas las
      lecturas.\textsuperscript{\protect\hyperlink{ref-smyth2004ebayes}{60}}
      A diferencia de un enfoque bayesiano puro, donde se asume una
      probabilidad previa para su actualización dado un evento
      condicionante, en un enfoque empírico esta información es obtenida
      de un \emph{pool} de elementos observados en el mismo experimento.
      Con esta distribución de varianzas corregida, se ejecuta un test-t
      con varianzas moderadas o test-t moderado empírico de Bayes capaz
      de obtener inferencias más estables que el test-t ordinario.
      ...
      (FDR).\textsuperscript{\protect\hyperlink{ref-brazma2001}{54}} Dos
      principales enfoques han sido propuestos. El enfoque
      probabilístico emplea modelos mixtos sobre la distribución de
      valores p para deferenciar a la población de hipótesis nulas y
      alternativas.\textsuperscript{\protect\hyperlink{ref-allison2002mmm}{63}}
      ...
      deseado.\textsuperscript{\protect\hyperlink{ref-benjamini1995fdr}{64}}
    \item
      \textbf{Clasificación}
      ...
      de respuesta
      humoral.\textsuperscript{\protect\hyperlink{ref-sundaresh2007}{65}}
      ...
      supervisada).\textsuperscript{\protect\hyperlink{ref-allison2006}{53}}
      ...
      Ejemplos de esta técnica son \emph{suport vector machines} (SVM),
      ...
      la distancia Euclidiana, en la que predomina la magnitud sobre la
      forma de la distribución de señales, y la correlación de Pearson,
      en la que predomina la forma sobre la magnitud. Ejemplo del
      segundo es el agrupamiento jerárquico o \emph{hierarchical
      clustering}, en la que los racimos o \emph{clusters} se forman
      iterativamente al calcular la distancia entre elemento y racimos
      en formación. Las principales desventajas de la técnica están en
      el requierimiento de decisiones entre varios algoritmos sin
      consenso y su escaza reproducibilidad entre experimentos.
    \end{enumerate}
  \item
    ...
    respuesta.\textsuperscript{\protect\hyperlink{ref-crompton2010}{9},\protect\hyperlink{ref-Helb2015exposure}{10},\protect\hyperlink{ref-King2015FOC}{51}}
    El primero se obtiene calculando la proporción de antígenos
    reactivos y el segundo por el promedio de sus intensidades por
    individuo. Particularmente, la amplitud ha demostrado tan relevante
    como la reactividad de antígenos individuales en el desarrollo de
    inmunidad contra la
  ...
  \item
    ...
    \item
      ...
      Prism),\textsuperscript{\protect\hyperlink{ref-molina2012}{66}}
      Baum et al. 2013, 2015 (SAM, MeV, JMP9.0 y
      Systat11),\textsuperscript{\protect\hyperlink{ref-baum2013}{67},\protect\hyperlink{ref-baum2015}{68}}
      Lu et al. 2014 (GraphPad, SigmaPlot10.0, Cluster3.0, TreeView y
      pearsoncorrelation.com),\textsuperscript{\protect\hyperlink{ref-lu2014rama}{69}}
      y Chen et al. 2015 (SAS, MULTTEST y TIGR
      MeV)\textsuperscript{\protect\hyperlink{ref-chen2015immunomics}{70}}
    \item
      \textbf{Libre}
      ...
      de análisis como
      Bioconductor\textsuperscript{\protect\hyperlink{ref-bioconductor2004}{71}}
      ...
      reportes\textsuperscript{\protect\hyperlink{ref-knitr}{72}} y
      ...
      visualizaciones,\textsuperscript{\protect\hyperlink{ref-Biobase}{73}}
    ...
    \item
      ...
      Tanto la heterogeneidad de softwares privativos, limitados
      principalmente por sus escasos métodos estadísticos y capacidades
      visuales, como las habilidades computacionales requeridas por las
      alternativas libres, servidores web como
      GMine\textsuperscript{\protect\hyperlink{ref-gmine2016}{74}} han
      sido desarrollados para el análisis integral y exploratorio. Sin
      embargo, la falta de reporte o regitro de los de parámetros
      empleados nuevamente cae en una escasa o dilatada reproducibilidad
      no automatizada.
    \end{enumerate}
  \end{enumerate}
\end{enumerate}
...
\item
  ...
  B.\textsuperscript{\protect\hyperlink{ref-abbas2012}{75}}

  \textbf{Inmunógeno.-} Un antígeno que induce una respuesta
  inmunitaria.\textsuperscript{\protect\hyperlink{ref-abbas2012}{75}}

  \textbf{Inmunoma.-} Conjunto de todos los inmunógenos que interactúan
  con el sistema inmune de determinado
  hospedero\textsuperscript{\protect\hyperlink{ref-immunomics2016}{76},\protect\hyperlink{ref-sette2005}{77}}

  \textbf{Inmunómica.-} Estudio del
  inmunoma.\textsuperscript{\protect\hyperlink{ref-immunomics2016}{76}}
  ...
  afinidad.\textsuperscript{\protect\hyperlink{ref-abbas2012}{75}}
...
previamente.\textsuperscript{\protect\hyperlink{ref-Driguez2015}{78}}
...
\texttt{Biobase}.\textsuperscript{\protect\hyperlink{ref-Biobase}{73}}
...
eBayes\textsuperscript{\protect\hyperlink{ref-smyth2004ebayes}{60}} con
...
paquete
\texttt{limma}.\textsuperscript{\protect\hyperlink{ref-limma}{79}}
...
\texttt{NMF}.\textsuperscript{\protect\hyperlink{ref-Gaujoux2010NMF}{80}}
...
de datos PlasmoDB.\textsuperscript{\protect\hyperlink{ref-plasmodb}{81}}
...
52. Sundaresh S, Doolan DL, Hirst S, et al. Identification of humoral
...
53. Allison DB, Cui X, Page GP, Sabripour M. Microarray data analysis:
...
54. Brazma A, Hingamp P, Quackenbush J, et al. Minimum information about
...
55. Kreil DP, Russell RR. Tutorial section: There is no silver
...
56. Arévalo-Herrera M, Lopez-Perez M, Dotsey E, et al. Antibody
...
57. Huber W, Von Heydebreck A, Sültmann H, Poustka A, Vingron M.
...
58. Sboner A, Karpikov A, Chen G, et al. Robust-linear-model
...
59. Bourgon R, Gentleman R, Huber W. Independent filtering increases
...
60. Smyth GK, others. Linear models and empirical bayes methods for
...
61. Baldi P, Long AD. A bayesian framework for the analysis of
...
62. Kayala MA, Baldi P. Cyber-t web server: Differential analysis of
...
63. Allison DB, Gadbury GL, Heo M, et al. A mixture model approach for
...
64. Benjamini Y, Hochberg Y. Controlling the false discovery rate: A
...
65. Sundaresh S, Randall A, Unal B, et al. From protein microarrays to
...
66. Molina DM, Finney OC, Arevalo-Herrera M, et al. Plasmodium vivax
...
67. Baum E, Badu K, Molina DM, Liang X, Felgner PL, Yan G. Protein
...
68. Baum E, Sattabongkot J, Sirichaisinthop J, et al. Submicroscopic and
...
69. Lu F, Li J, Wang B, et al. Profiling the humoral immune responses to
...
70. Chen J-H, Chen S-B, Wang Y, et al. An immunomics approach for the
...
71. Gentleman RC, Carey VJ, Bates DM, et al. Bioconductor: Open software
...
72. Xie Y. Knitr: A general-purpose tool for dynamic report generation
in r. \emph{R package version}. 2013;1(1).
\url{http://yihui.name/knitr/}.

\hypertarget{ref-Biobase}{}
73. Huber, W., Carey, et al. Orchestrating high-throughput genomic
...
74. Proietti C, Zakrzewski M, Watkins TS, et al. Mining, visualizing and
...
75. Abbas A, Lichtman A, Pillai S. \emph{Inmunología Celular Y Molecular
...
76. De Sousa KP, Doolan DL. Immunomics: A 21st century approach to
vaccine development for complex pathogens. \emph{Parasitology}.
2016;143(02):236-244.

\hypertarget{ref-sette2005}{}
77. Sette A, Fleri W, Peters B, Sathiamurthy M, Bui H-H, Wilson S. A
roadmap for the immunomics of category a--C pathogens. \emph{Immunity}.
2005;22(2):155-161.

\hypertarget{ref-Driguez2015}{}
78. Driguez P, Doolan DL, Molina DM, et al. Protein microarrays for
...
79. Ritchie ME, Phipson B, Wu D, et al. limma powers differential
expression analyses for RNA-sequencing and microarray studies.
\emph{Nucleic Acids Research}. 2015;43(7):e47.

\hypertarget{ref-Gaujoux2010NMF}{}
80. Gaujoux R, Seoighe C. A flexible r package for nonnegative matrix
...
81. Aurrecoechea C, Brestelli J, Brunk BP, et al. PlasmoDB: A functional
