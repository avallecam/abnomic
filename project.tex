...
R\textsuperscript{\protect\hyperlink{ref-R}{17}} para el análisis de
datos. Esta plataforma facilitará la reproducibilidad del estudio,
promoviendo su reutilización y contribución por otros
grupos\textsuperscript{\protect\hyperlink{ref-CienciaReproducible2016}{18}}.
...
\item
  ...
  \item
    ...
    \item
      ...
      natural\textsuperscript{\protect\hyperlink{ref-cohen1961}{46},\protect\hyperlink{ref-sabchareon1991}{47}}.
...
\item
  ...
  \item
    ...
    \item
      ...
      expresión
      similar\textsuperscript{\protect\hyperlink{ref-baldi2001cybert}{67}}.
      ...
      varianzas
      observadas\textsuperscript{\protect\hyperlink{ref-smyth2004ebayes}{66}}.
      ...
      réplicas\textsuperscript{\protect\hyperlink{ref-kayala2012cyber}{68}}.
  ...
  \item
    ...
    \item
      ...
      R\textsuperscript{\protect\hyperlink{ref-R}{17}} junto a ambientes
      de análisis como
      ...
      Reproducible\textsuperscript{\protect\hyperlink{ref-CienciaReproducible2016}{18}}.
      \newpage
    \item
      \textbf{Servidores}
...
estadística R\textsuperscript{\protect\hyperlink{ref-R}{17}}, el cual se
...
la distribución. Segundo, se realizará un test de reactividad
diferenciada de anticuerpos entre dos grupos, usando el test-t
...
PlasmoDB\textsuperscript{\protect\hyperlink{ref-plasmodb}{86}} para el
...
Las pruebas estadísticas serán reportadas con el valor del estadístico,
valor p y valor p-ajustado para la comparación múltiple. Las
distribuciones serán visualizadas con diagramas de dispersión para la
correlación entre variables continuas, diagramas de cajas y barras para
la comparación de variables continuas y frecuencias, respectivamente,
diagramas tipo volcán o \emph{volcano plots} para la reactividad
diferenciada entre grupos contra sus respectivos valores p no-ajustados,
y mapa de calor o \emph{heat map} segmentado por racimos o
\emph{clusters} para el perfil serológico general.
...
\textcolor{red}{\hl{financiado por ****}}.
...
18. Rodríguez-Sanchez F, Pérez-Luque AJ, Bartomeus I, Varela S. Ciencia
...
81. Abbas A, Lichtman A, Pillai S. \emph{Inmunología Celular Y
