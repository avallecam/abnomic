...
\afterpage{
    \clearpage
    \newgeometry{left=2cm,right=0.5cm,top=0.5cm,bottom=0.5cm}
    \thispagestyle{empty}
    \begin{landscape}
        \centering
\begin{center}
...
\begin{tabular}{|m{2.8cm}m{2.8cm}m{2.8cm}m{2.8cm}m{2.8cm}m{2.8cm}m{2.8cm}m{2.8cm}|}
  ...
  \textbf{Título:}
  &
  \multicolumn{7}{l|}{ %>{\centering}m{19cm}
  \begin{minipage}{19.6cm}
  Comparación de la respuesta de anticuerpos ante la %infección con 
  malaria vivax
  en pacientes de la Amazonía peruana %ciudad de Iquitos (Loreto - Perú)
  según su severidad y episodios previos %exposición previa
  ...
  \textbf{Diseño} & \textbf{Muestra} & \textbf{Instrumentos} & \textbf{Análisis}\\
  \hline
