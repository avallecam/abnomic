...
\item
  ...
  \item
    ...
    malaria falciparum en una década
    ...
    casos anuales en la historia (200,000 casos), con mayor efecto en el
    Norte
...
\item
  ...
  \item
    ...
    agudo (14\%) y Glasgow \(\le\) 9/14 (11\%). Comparados con los
    pacientes no complicados, los severos fueron mayores (38 vs 26 años,
    P\textless{}0.001).
    ...
    identificó 55/164 casos de malaria vivax severa con shock
    circulatorio (27.6\%), daño pulmonar (24.5\%) hiperbilirubina
...
\item
  ...
  infecciones como HBsAg contra la hepatitis B y BCG contra la
  tuberculosis,
...
En la \autoref{tab:crono} se programan las actividades paralelas y
...
\begin{tabular}{|m{3.2cm}m{3.2cm}m{3.2cm}m{3.2cm}m{3.2cm}m{3.2cm}m{3.2cm}|}
  ...
  con reactividad serológica discriminante de condiciones 
  clínicas relevantes ante la infección con malaria vivax.\\
  \newline
  \textbf{Específicos}\\
