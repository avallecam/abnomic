...
\item
  ...
  \item
    ...
    afinidad entre péptidos del patógeno y determinadas moléculas MHC
    del hospedero. La principal ventaja del primer método está en la
    capacidad de priorizar la selección de antígenos en base a criterios
    clínicamente relevantes, como el de individuos con inmunidad por
    adquisición
