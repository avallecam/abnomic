...
```{r, warning=FALSE,  fig.width=10, fig.height=10, eval=FALSE}
par(mfrow=c(3,3))
...
```{r, warning=FALSE, fig.height=9, fig.width=10, eval=FALSE}
...
```{r, fig.align="center", fig.height=6, fig.width=10, warning=FALSE, eval=FALSE}
...
```{r, fig.height=6, fig.width=6, fig.align='center', warning=FALSE, message=FALSE, eval=FALSE}
#library(ggplot2)
#library(Rmisc)
