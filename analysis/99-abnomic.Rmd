...
MSP1_S1.x <- MSP1_S1 %>%
  ...
  #geom_density(alpha=.3) +
  labs(title="Normalized intensity against MSP1_S1 per specie")
MSP1_S1.xd <- MSP1_S1 %>%
  gather(specie, intensity, PfMSP1_S1:PvMSP1_S1) %>%
  mutate(specie=factor(specie)) %>%
  #filter(con_exp=="CON") %>%
...
MSP1_S2.x <- MSP1_S2 %>%
  ...
  geom_histogram(alpha=.5 ,position = "identity") + 
  #geom_density(alpha=.3) +
  labs(title="Normalized intensity against MSP1_S2 per specie")
MSP1_S2.xd <- MSP1_S2 %>%
  gather(specie, intensity, PfMSP1_S2:PvMSP1_S2) %>%
  mutate(specie=factor(specie)) %>%
  #filter(con_exp=="CON") %>%
...
MSP10.x <- MSP10 %>%
  ...
  geom_histogram(alpha=.5 ,position = "identity") + 
  #geom_density(alpha=.3) +
  labs(title="Normalized intensity against MSP10 per specie")
MSP10.xd <- MSP10 %>%
  gather(specie, intensity, PfMSP10:PvMSP10) %>%
  mutate(specie=factor(specie)) %>%
  #filter(con_exp=="CON") %>%
...
EdadBreadth1x <- ggplot(corrXX, aes(x=edad_CAT,y=breadth.percentage
                                  #, fill=casecontrol
                                  )) +geom_boxplot() #+ geom_point() + geom_smooth(alpha=.2) #+ ggtitle("xx") + geom_line() + # group=con_exp
...
#corrX
EdadBreadth1 <- ggplot(corrX, aes(x=edad,y=breadth.percentage, colour=casecontrol)) + geom_point() + geom_smooth(alpha=.2) #+ ggtitle("xx") + geom_line() + # group=con_exp
#ggplot(corrX, aes(x=edad,y=breadth.percentage, colour=casecontrol)) + geom_point() + geom_smooth(alpha=.2,size=.1) #+ ggtitle("xx") + geom_line() + # group=con_exp
...
EdadBreadth3 <- ggplot(corrX, aes(x=edad,y=breadth.percentage, colour=con_exp)) + geom_point() + geom_smooth(alpha=.2) #+ ggtitle("xx") + geom_line() + # group=con_exp
#ggplot(corrX, aes(x=edad,y=breadth.percentage, colour=casecontrol)) + geom_point() + geom_smooth(alpha=.2,size=.1) #+ ggtitle("xx") + geom_line() + # group=con_exp
...
#corrX
EdadBreadth1 <- ggplot(corrX, aes(x=edad_CAT,y=breadth.percentage, fill=casecontrol)) +geom_boxplot() #+ geom_point() + geom_smooth(alpha=.2) #+ ggtitle("xx") + geom_line() + # group=con_exp
#ggplot(corrX, aes(x=edad,y=breadth.percentage, colour=casecontrol)) + geom_point() + geom_smooth(alpha=.2,size=.1) #+ ggtitle("xx") + geom_line() + # group=con_exp
...
EdadBreadth3 <- ggplot(corrX, aes(x=edad_CAT,y=breadth.percentage, fill=con_exp)) +geom_boxplot() # + geom_point() + geom_smooth(alpha=.2) #+ ggtitle("xx") + geom_line() + # group=con_exp
#ggplot(corrX, aes(x=edad,y=breadth.percentage, colour=casecontrol)) + geom_point() + geom_smooth(alpha=.2,size=.1) #+ ggtitle("xx") + geom_line() + # group=con_exp
