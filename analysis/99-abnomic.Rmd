...
#par(mfcol=c(4,3))
#
plotDensities(all.raw_data, legend = FALSE, main = "Raw Intensity")
plotDensities(log2.NA(all.raw_data), legend = FALSE, main = "Transformed Intensity")#log2.NA.norm.ANTIGENS
plotDensities(normalized.log2.NA.norm.ANTIGENS, legend = FALSE, main = "Normalized Intensity")
plotDensities(exprs(normal.log2.raw.eSet.FILTER), legend = FALSE, main = "Filtered Intensity")
#
hist(all.raw_data,breaks=600, col = "black", main = NULL, ylim = c(0,2500),
     ylab="Raw Intensity")
hist(log2.NA(all.raw_data),breaks=600, col = "black", main = NULL, ylim = c(0,2500),
...
hist(exprs(normal.log2.raw.eSet.FILTER),breaks=600, col = "black", main = NULL, ylim = c(0,2500),
     ylab="Filtered Intensity")           # THIS IS IT!!
#
boxplot(all.raw_data,col=colours,pch=20, las=2, 
        ylab="Raw Intensity")
boxplot(log2.NA(all.raw_data),col=colours,                 #JUST log2 NORMALIZATION #log2.NA.norm.ANTIGENS
        pch=20, #ylim=c(-3,6.3),
        las=2, 
...
```{r, fig.height=4, fig.width=9, fig.align='center', warning=FALSE, message=FALSE, eval=FALSE}
...
```{r, fig.height=8, fig.width=8, fig.align="center", message=FALSE, eval=FALSE}
# PF3D7_0620400.974	falciparum	IVTT.AG	PF3D7_0620400	merozoite surface protein 10 (MSP10)
# PVX_114145_1o1.272	vivax	IVTT.AG	PVX_114145	Merozoite surface protein 10, MSP10
