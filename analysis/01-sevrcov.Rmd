---
title: "COVARIATES (update: sep2016)"
...
- **new** variables `glas_11` and `sev_WHO`
...
- **change** `NA` to `0` among severe [covariates](#symptoms-frequency)
...
- Add `parasitemia` from `28Nov2014_Ed.dta` **WARNING**
...
- significant differences with respect to 
    + previous episodes of malaria and 
...
**On previouse episodes of malaria**
...
- significant differences with respect to 
    + presence of comorbidities among severe patients with previous episodes
