...
ax <- qplot(td$P.Value, binwidth=.05) +
  labs(title="P-value histogram",
       subtitle="Without multiple testing correction") + xlab("p.value")
bx <- qplot(td$adj.P.Val, binwidth=.05) +
  coord_cartesian(xlim = c(0,1)) +
  labs(title="P-value histogram",
       subtitle="After multiple testing correction") + xlab("adjust p.value")
Rmisc::multiplot(ax,bx,cols = 2)
```

###### volcano plot

```{r, fig.height=6, fig.width=5.15}
td %>% 
...
td %>% 
  ...
  labs(title="With vs Without previous episode",
       ...
       subtitle="Effect size against statistical significance",
       #subtitle="Tamaño del efecto y significancia estadística",
       caption="annotated features filtered by\n(adj.P.Val<0.05 & logFC>1.5) | con>AveExpr(top1)")+
  # or (adj.P.Val<0.001 & con>AveExpr(top1))
  geom_hline(aes(yintercept=-log10(0.01)), lty=3)+
  geom_vline(aes(xintercept=1), lty=3) +
  coord_cartesian(xlim = c(-2, 2), ylim = c(0,15)) 
...
l <- td %>% 
  ...
  labs(title="Distribution of logFC",
       subtitle="filtered by adj.P.Val<0.05")
...
```{r, fig.width=5.7,fig.height=4.5, echo=TRUE}
eset <- eset.VIVAX.SEV.FILTER
...
r <- fin %>% 
  ...
  xlab("Previous Episodes") + ylab("Percent Reactive") +
  labs(title="Breadth of Ab response", 
       subtitle= paste0("t=",j$statistic,", df=",j$parameter,", P=",j$p.value),
       caption=paste0("method: ",j$method)) #+ theme_classic()
...
s <- fin %>% 
  ...
  scale_x_discrete(labels = c("with","without")) +
  xlab("Previous Episodes") + ylab("Mean Intensity") +
  labs(title="Intensity of Ab response", 
       subtitle= paste0("t=",k$statistic,", df=",k$parameter,", P=",k$p.value),
       caption=paste0("method:",k$method)) #+ theme_classic()
...
r <- fin %>% 
  ...
  scale_fill_discrete(name="WHO criteria",
                      ...
                      labels=c("non-severe", "severe")) +
  xlab("Categorized Age") + ylab("Percent Reactive") +
  labs(title="Breadth of Ab response", subtitle="per Age and Severity") #+ theme_classic()
...
s <- fin %>% 
  ...
  scale_fill_discrete(name="WHO criteria",
                      ...
                      labels=c("non-severe", "severe")) +
  xlab("Categorized Age") + ylab("Mean Intensity") +
  labs(title="Intensity of Ab response", subtitle="per Age and Severity") #+ theme_classic()
...
t <- fin %>% 
  ...
  scale_fill_discrete(name="Previous\nEpisodes",
                      ...
                      labels=c("with", "without")) +
  xlab("Categorized Age") + ylab("Percent Reactive") +
  labs(title="Breadth of Ab response", subtitle="per Age and Previous Episodes") #+ theme_classic()
...
u <- fin %>% 
  ...
  scale_fill_discrete(name="Previous\nEpisodes",
                      ...
                      labels=c("with", "without")) +
  xlab("Categorized Age") + ylab("Mean Intensity") +
  labs(title="Intensity of Ab response", subtitle="per Age and Previous Episodes") #+ theme_classic()
