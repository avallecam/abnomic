...
tab_ws <- compareGroups(Study ~ 
                          ...
                          sev_WHO #+ #sev_WHO_num +
                ,
              data = sevdb_2ws, byrow=F, method=c(edad=2,en_zona_endemica=2,episodio_previo_num=2,parasitemia_mil=2)
              ) 
...
#hist(sevdb_2ws$episodio_previo_num)
#sevdb_2ws %>% dplyr::count(episodio_previo_num)
tab_cr <- compareGroups(casecontrol ~ #Study ~ 
                          #casecontrol + 
                          Study + 
                          sev_WHO_2 + 
                          shock_oms + #clinicos
                          ...
                          #enf_cronica
                          #parasitemia + 
                          sev_WHO_num_2 #+ sev_WHO_num_4
                          #sev_WHO_num + sev_WHO_num_1 + sev_WHO_num_2 + sev_WHO_num_3 + sev_WHO_num_4
                ,
              data = sevdb_2ws, byrow=T#, method=c(edad=2,en_zona_endemica=2,episodio_previo_num=2,parasitemia=2)
              ) 
#tab_cr %>% createTable(show.all = T,show.n = T,hide.no = "0") #%>% export2xls("table/tab1.xls")
